    ...
    <Section className="bg-brand-dark trust-glow-bg" id="trust" noAnimate>
      ...
      >
        ...
        <motion.p variants={fadeInUp} className="mt-4 text-lg text-slate-300 leading-relaxed">
          Built by <span className="font-semibold text-white">Mike Olaski</span>&nbsp;&mdash;
        ...
        <motion.p variants={fadeInUp} className="mt-8 text-lg text-slate-400 leading-relaxed">
          This isn&rsquo;t our first rodeo. We&rsquo;ve seen what works, what fails, and what wastes
          money. Our job is to make sure you only invest in what works.
        </motion.p>
      </motion.div>
    </Section>
  );
