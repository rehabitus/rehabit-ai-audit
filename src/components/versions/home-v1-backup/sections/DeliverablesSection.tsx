...
import { Section } from "@/components/versions/home-v1-backup/ui/Section";
...
const SVGS = [
  (
    <svg key="deliverable-svg-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" className="h-16 w-16">
  ...
  (
    <svg key="deliverable-svg-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" className="h-16 w-16">
  ...
  (
    <svg key="deliverable-svg-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" className="h-16 w-16">
    ...
    <Section className="bg-brand-dark" id="deliverables">
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="mb-16 w-full overflow-hidden rounded-2xl shadow-[0_0_80px_rgba(16,185,129,0.1)] relative aspect-[2/1] md:aspect-video">
          <Image
            src="/images/section-header-heros/4C-Audit-2a.jpg"
