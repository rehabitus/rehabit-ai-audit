            ...
            >
                {showVideo ? (
                    ...
                    >
                        ...
                        <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-brand-green/25 text-slate-950 shadow-lg shadow-brand-green/25 transition-transform group-hover:scale-110">
                            <svg
