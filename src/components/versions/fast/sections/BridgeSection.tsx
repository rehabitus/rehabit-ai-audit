...
export function BridgeSection() {
  ...
  return (
    <Section className="bg-brand-dark dot-grid-bg py-10 md:py-14" id="why-now" noAnimate>
      <motion.div
      ...
      >
        ...
        <motion.ul variants={fadeInUp} className="mt-6 space-y-3 text-left inline-block">
          {bullets.map((bullet, i) => (
            <li key={i} className="flex items-start gap-3 text-slate-300 text-base md:text-lg">
